...
public class MyOreoWifiManager {
    ...
    private static final String TAG = MyOreoWifiManager.class.getName();
    ...
    public void configureHotspot(String name, String password) {
        ...
        try {
            Method setConfigMethod = mWifiManager.getClass()
    ...
    public boolean startTethering(final MyOnStartTetheringCallback callback) {
        ...
        Method method = null;
        try {
            method = mConnectivityManager.getClass()
                    .getDeclaredMethod("startTethering", int.class, boolean.class, OnStartTetheringCallbackClass(),
                            Handler.class);
            if (method == null) {
